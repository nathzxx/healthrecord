...
use BezhanSalleh\FilamentShield\FilamentShieldPlugin; // Import FilamentShieldPlugin
...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->favicon(asset('images/logo.blade.png'))
            ...
            ->plugins([
                FilamentShieldPlugin::make(), // ✅ Correct way to include Filament Shield
            ]);
    }
}
